...
function installORM() {
    return new Promise(function (resolve, reject) {
        var objs = [
                {
                    reg: /What environment is this configuration for\?/,
                    write: '\n',
                    done: false
                },
                {
                    reg: /Database username/,
                    write: 'travis\n',
                    done: false
                },
                {
                    reg: /Database password/,
                    write: '\n',
                    done: false
                },
                {
            ...
            proc = spawn('clever install clever-orm', {
                cwd: path.resolve(path.join(__dirname, '..'))
            }, function () {});
